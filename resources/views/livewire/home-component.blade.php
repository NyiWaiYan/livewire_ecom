...
background: rgba(250, 104, 189, 0.2);
border-radius: 16px;
box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
backdrop-filter: blur(5px);
-webkit-backdrop-filter: blur(3px);
border: 1px solid rgba(250, 104, 189, 0.3);
		padding: 40px;
		margin-left: 200px;
			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					...
					<div class="item-slide ">
						<img src="{{ asset('assets/images/sliders')}}/{{ $slide->image }}" height="350px" alt="" class="img-slide">
						<div class="slide-info bgw slide-1">
							<h2 class="f-title"> <b>{{ $slide->title }}</b></h2>
							<span class="subtitle">{{ $slide->subtitle }}</span>
							<p class="sale-info">Only price: <span class="price">{{ $slide->price }} MMK</span></p>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							...
							<div class="wrap-price"><ins><p class="product-price">
								{{ $sproduct->sale_price }} MMK
							</p></ins> <del><p class="product-price">
								{{ $sproduct->regular_price }} MMK
							</p></del></div>
						</div>
					</div>
					@endforeach
								...
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
									...
									<div class="product product-style-2 equal-elem ">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">{{ $lproduct->regular_price }}MMK</span></div>
										</div>
									</div>
									@endforeach
